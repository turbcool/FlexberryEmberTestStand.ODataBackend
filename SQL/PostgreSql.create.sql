...
CREATE INDEX Index4c37373baa854bb3b653f859e038b17f on CommentVote (Comment);
 ...
 ALTER TABLE Departament ADD CONSTRAINT FK75c351968575402db87e420f3e478841 FOREIGN KEY (vid) REFERENCES VidDepartamenta;
CREATE INDEX Index55dd9f71d97981ee2ab6b7fa3927b3349dbd5d03 on Departament (vid);

 ALTER TABLE Sotrudnik ADD CONSTRAINT FK33e77e920da142088ddab5412f1074d7 FOREIGN KEY (Departament) REFERENCES Departament;
CREATE INDEX Index1aa1deb1efef8406ec5a55494fe23144d7d63ba3 on Sotrudnik (Departament);
